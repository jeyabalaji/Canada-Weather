...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("XMLParsingDemo", withExtension: "momd")!
    ...
    func preloadData () {
        let localURL = NSBundle.mainBundle().URLForResource("feed", withExtension: "csv")
